...
type ThemeContextValue = {
  ...
  /** AsyncStorage'dan tema yüklendiğinde true olur. Splash screen bunu beklemeli. */
  themeLoaded: boolean;
};
...
export function ThemeProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    AsyncStorage.getItem(THEME_STORAGE_KEY)
      ...
      .finally(() => {
        setThemeLoaded(true); // splash screen artık kapanabilir
      });
  ...
  const value = useMemo(
    () => ({ colorScheme, setColorScheme, themeLoaded }),
    [colorScheme, setColorScheme, themeLoaded],
  );
